...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, W25Qx_CS_Pin|NRF_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CS_Pin|LCD_DC_Pin|LCD_RES_Pin|LCD_BLK_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : KEY_B_Pin KEY_C_Pin */
  GPIO_InitStruct.Pin = KEY_B_Pin|KEY_C_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : W25Qx_CS_Pin NRF_CE_Pin NRF_CS_Pin */
  GPIO_InitStruct.Pin = W25Qx_CS_Pin|NRF_CE_Pin|NRF_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : KEY_F_Pin KEY_E_Pin KEY_D_Pin */
  GPIO_InitStruct.Pin = KEY_F_Pin|KEY_E_Pin|KEY_D_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
