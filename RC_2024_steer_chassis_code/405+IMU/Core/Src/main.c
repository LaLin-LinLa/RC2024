...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : MPU2_CS_Pin */
  GPIO_InitStruct.Pin = MPU2_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(MPU2_CS_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : MPU1_CS_Pin */
  GPIO_InitStruct.Pin = MPU1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(MPU1_CS_GPIO_Port, &GPIO_InitStruct);
