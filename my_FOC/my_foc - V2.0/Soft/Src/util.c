...
inline void inverse_clarke(float mod_alpha, float mod_beta, float *Ua, float *Ub, float *Uc)
{
    *Ua = mod_beta;
    *Ub = -0.5*mod_beta + SQRT3_BY_2*mod_alpha;
    *Uc = -0.5*mod_beta - SQRT3_BY_2*mod_alpha;
}
