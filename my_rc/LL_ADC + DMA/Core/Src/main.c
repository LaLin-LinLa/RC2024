...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, NRF_CS_Pin|LCD_DC_Pin|LCD_CS_Pin|LCD_BLK_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : NRF_CS_Pin NRF_CE_Pin LCD_BLK_Pin */
  GPIO_InitStruct.Pin = NRF_CS_Pin|NRF_CE_Pin|LCD_BLK_Pin;
